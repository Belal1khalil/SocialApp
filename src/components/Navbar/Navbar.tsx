      ...
      <div className="container mx-auto px-4 lg:px-8">
          ...
          <nav className="hidden md:flex items-center gap-8">
            ...
            <div className="relative" ref={userMenuRef}>
              ...
              >
                ...
                <HiChevronDown className={`text-gray-400 group-hover:text-primary-600 transition-transform duration-300 ${userMenuOpen ? "rotate-180" : ""}`} />
              </button>
              ...
              {userMenuOpen && (
                <div className="absolute right-0 mt-3 w-48 bg-white rounded-2xl shadow-xl border border-gray-100 py-2 animate-in fade-in zoom-in duration-200">
                  <Link href="/profile" className="block px-4 py-2.5 text-sm text-gray-700 hover:bg-primary-50 hover:text-primary-600 transition-colors">Profile</Link>
                  <Link href="/settings" className="block px-4 py-2.5 text-sm text-gray-700 hover:bg-primary-50 hover:text-primary-600 transition-colors">Settings</Link>
                  <hr className="my-1 border-gray-100" />
                  <button className="w-full text-left block px-4 py-2.5 text-sm text-red-600 hover:bg-red-50 transition-colors">Logout</button>
                </div>
              )}
            </div>
        ...
        >
          <div className="flex flex-col p-6 gap-4">
            ...
            >
              <HiUserCircle size={24} className="text-primary-500" /> My Profile
            </Link>
            <Link 
              href="/login" 
